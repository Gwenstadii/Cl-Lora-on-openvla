...
class aloha_grab_roller_clean(MultiThreadedDatasetBuilder):
    VERSION = tfds.core.Version("1.0.0")
    RELEASE_NOTES = {"1.0.0": "RoboTwin grab_roller clean"}
    ...
    def _split_paths(self):
        base = "../../data/grab_roller/processed_openvla"
        return {"train": glob.glob(f"{base}/train/*.hdf5"), "val": glob.glob(f"{base}/val/*.hdf5")}


if __name__ == "__main__":
    aloha_grab_roller_clean().download_and_prepare()
