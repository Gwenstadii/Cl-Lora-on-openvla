...
class aloha_stack_bowls_two_clean(MultiThreadedDatasetBuilder):
    VERSION = tfds.core.Version("1.0.0")
    RELEASE_NOTES = {"1.0.0": "RoboTwin stack_bowls_two clean"}
    ...
    def _split_paths(self):
        base = "../../data/stack_bowls_two/processed_openvla"
        return {"train": glob.glob(f"{base}/train/*.hdf5"), "val": glob.glob(f"{base}/val/*.hdf5")}


if __name__ == "__main__":
    aloha_stack_bowls_two_clean().download_and_prepare()
