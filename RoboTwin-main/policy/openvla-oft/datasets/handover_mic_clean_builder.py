...
class aloha_handover_mic_clean(MultiThreadedDatasetBuilder):
    VERSION = tfds.core.Version("1.0.0")
    RELEASE_NOTES = {"1.0.0": "RoboTwin handover_mic clean"}
    ...
    def _split_paths(self):
        base = "../../data/handover_mic/processed_openvla"
        return {"train": glob.glob(f"{base}/train/*.hdf5"), "val": glob.glob(f"{base}/val/*.hdf5")}


if __name__ == "__main__":
    aloha_handover_mic_clean().download_and_prepare()
