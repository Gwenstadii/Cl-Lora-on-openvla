    ...
    if cfg.use_lora:
        if cfg.use_cl_lora:
            ...
            if cfg.lora_scope == "cl":
                # 与 CL-LoRA 对齐: 仅 L16-31 的 attn q/k/v/o + ffn gate/up/down (PEFT regex, 任意前缀)
                target_modules = r".*\.layers\.(1[6-9]|2[0-9]|3[01])\.(self_attn\.(q|k|v|o)_proj|mlp\.(gate|up|down)_proj)$"
            else:
